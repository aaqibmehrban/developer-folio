...
export const projects: Project[] = [
  ...
  {
    slug: "sar-ship-detection",
    title: "SAR Ship Detection: RetinaNet vs YOLO11s vs RF-DETR Benchmark",
    dateRange: "Aug 2026",
    year: "2026",
    sortYear: 2026,
    madeAt: "Personal Project",
    description: "A from-scratch RetinaNet, a fine-tuned YOLO11s, and a fine-tuned RF-DETR-Small, benchmarked on HRSID SAR ship detection with one shared, pycocotools-validated mAP implementation.",
    fullDescription: [
    ...
    skills: ["Python","PyTorch","Object Detection","Computer Vision","SAR Remote Sensing","RetinaNet","YOLO11","RF-DETR","ESA SNAP","Sentinel-1","Model Benchmarking"],
    url: "https://github.com/aaqibmehrban/sar-ship-detection",
    urlLabel: "View on GitHub",
    image: "/images/project/sar-ship/helsinki_full_scene.jpg",
    featured: true,
    gallery: [
      {
        title: "Detection Accuracy by Split (mAP@0.5:0.95)",
        type: "image",
        src: "/images/project/sar-ship/map_comparison.png",
        description: "RF-DETR-Small leads on every split — full test, inshore, and offshore — despite fewer parameters and less training than RetinaNet.",
      },
      {
        title: "Recall by Split",
        type: "image",
        src: "/images/project/sar-ship/recall_comparison.png",
        description: "Recall is where the gap is starkest: RF-DETR finds 0.672 of ground-truth ships inshore versus RetinaNet's 0.304 — more than double.",
      },
      {
        title: "Full Helsinki Coastal SAR Scene",
        type: "image",
        src: "/images/project/sar-ship/helsinki_full_scene.jpg",
        description: "A 6720×9323px Sentinel-1 GRD scene of the Helsinki coast, processed through ESA SNAP and run through all three detectors — a different sensor and location than anything in training, with no ground truth to score against.",
      },
      {
        title: "Detection Close-up",
        type: "image",
        src: "/images/project/sar-ship/helsinki_detection_crop.jpg",
        description: "A cropped detail from the Helsinki scene showing individual ship detections and their confidence scores.",
      },
      {
        title: "Detections on the Helsinki Scene",
        type: "image",
        src: "/images/project/sar-ship/helsinki_detection_counts.png",
        description: "With no ground truth, a detection count isn't a score — but RF-DETR finding roughly twice as many candidates as YOLO11s lines up with the same gap seen in the scored HRSID results.",
      },
    ],
  },
  {
